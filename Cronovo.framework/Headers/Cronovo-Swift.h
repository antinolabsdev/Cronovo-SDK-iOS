...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Cronovo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

typedef SWIFT_ENUM(int64_t, CardiacDuration, open) {
...
- (void)ConfigureWithAge:(NSInteger)age weight:(NSInteger)weight height:(NSInteger)height;
...
typedef SWIFT_ENUM(NSInteger, HeartZone, open) {
  HeartZoneZone1 = 50,
  HeartZoneZone2 = 60,
  HeartZoneZone3 = 70,
  HeartZoneZone4 = 80,
...
typedef SWIFT_ENUM(NSInteger, RecoveryTime, open) {
  RecoveryTimeThirtySec = 30,
  RecoveryTimeSixtySec = 60,
  RecoveryTimeOneTwentySec = 120,
};

typedef SWIFT_ENUM(NSInteger, Scale, open) {
  ScaleCelsius = 0,
  ScaleFahrenheit = 1,
};
